 ...
 * @author HP
 */
public class JFSeleccionRol extends javax.swing.JFrame {

    /**
     * Creates new form JFSeleccionRol
     */
    public JFSeleccionRol() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jBRecepcion.setBackground(new java.awt.Color(255, 255, 255));
        jBRecepcion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/iconoLogin.png"))); // NOI18N
        jBRecepcion.setText("Ingresar como Recepcionista");
        ...
        jBAdministracion.setBackground(new java.awt.Color(255, 255, 255));
        jBAdministracion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/iconoLogin.png"))); // NOI18N
        jBAdministracion.setText("Ingresar como Administrador");
    ...
    private void jBAdministracionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAdministracionActionPerformed
        JFLoginAdministracion loginAdministrador = new JFLoginAdministracion();
    ...
    private void jBRecepcionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBRecepcionActionPerformed
        JFLoginRecepcion loginRecepcion = new JFLoginRecepcion();
       loginRecepcion.setVisible(true);
       this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFSeleccionRol.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFSeleccionRol().setVisible(true);
            }
        });
    }
