 ...
 * @author Brandon Oña
 */
public class JIFRegistrarUsuario extends javax.swing.JInternalFrame {

    Conexion con = new Conexion();
    Metodos ins;

    public JIFRegistrarUsuario() {
        initComponents();
        ins = new Metodos();
        MostrarTablaUsuario("");
   ...
   /* public boolean habilitarBotonv1() {
    ...
    private void initComponents() {
        ...
        jBGuardarUsuario.setText("Guardar Usuario");
    ...
    private void jBGuardarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuardarUsuarioActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "El usuario ha sido registrado de forma exitosa");
