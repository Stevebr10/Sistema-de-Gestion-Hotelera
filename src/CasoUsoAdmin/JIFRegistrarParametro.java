 ...
 * @author JHON
 */
public class JIFRegistrarParametro extends javax.swing.JInternalFrame {

    Conexion con = new Conexion();
    Metodos ins;
    
    public JIFRegistrarParametro() {
        initComponents();
    ...
    public void MostrarTablaPara(String Nombre) {
        ...
        sql= "SELECT * FROM PARAMETRO WHERE Nombre like '%"+Nombre+"%'";
         }
        ...
        try {
            ...
            Logger.getLogger(JIFRegistrarParametro.class.getName()).log(Level.SEVERE, null, ex);
   ...
   /* public void validarCamposVacios() {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Registrar Parámetro"));
    ...
    private void jBGenerarInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGenerarInActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Parámetro registrado");
