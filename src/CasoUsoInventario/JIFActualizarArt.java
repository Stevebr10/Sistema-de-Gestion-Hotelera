 ...
 * @author Brandon Oña
 */
public class JIFActualizarArt extends javax.swing.JInternalFrame {

    Conexion con = new Conexion();
    Metodos ins;
    
    public JIFActualizarArt() {
        initComponents();
    ...
    public void MostrarTablaIn(String Nombre) {
        ...
        try {
            ...
            Logger.getLogger(JIFActualizarArt.class.getName()).log(Level.SEVERE, null, ex);
   ...
   /* public void validarCamposVacios() {
    ...
    public void habilitarBoton() {
        ...
        if (jTNumHabitacion.getText().isEmpty()
    ...
    private void initComponents() {
        ...
        jTNumHabitacion = new javax.swing.JTextField();
        ...
        jTNumHabitacion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTNumHabitacionActionPerformed(evt);
            }
        });
        jTNumHabitacion.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTNumHabitacionKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTNumHabitacionKeyTyped(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jTNumHabitacion, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel12)
                    .addComponent(jTNumHabitacion, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
    ...
    private void jTNumHabitacionKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTNumHabitacionKeyReleased
         //habilitarBoton();
        //validarCamposVacios();
    }//GEN-LAST:event_jTNumHabitacionKeyReleased

    private void jTNumHabitacionKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTNumHabitacionKeyTyped
        //validarFecha(evt);
    }//GEN-LAST:event_jTNumHabitacionKeyTyped
    ...
    private void jBGenerarInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGenerarInActionPerformed
        Inventario aux = new Inventario(Integer.parseInt(this.jTNumHabitacion.getText()), Integer.parseInt(this.jTFidPersonal.getText()) , 
                this.jTFNombre.getText(), Integer.parseInt(this.jTFCantidad.getText()),
                this.jTFEstado.getText());
        int posicion = jTableInventario.getSelectedRow();
            String valor = jTableInventario.getValueAt(posicion, 0).toString();
        try {
            ins.ActualizarArticulo(aux,Integer.parseInt(valor));
            MostrarTablaIn("");
    ...
    private void jTNumHabitacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTNumHabitacionActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTNumHabitacionActionPerformed
    ...
    private void jBActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBActualizarActionPerformed
        ...
        if (fila >= 0) {
            ...
            this.jTNumHabitacion.setText(jTableInventario.getValueAt(fila, 0).toString());
            this.jTFidPersonal.setText(jTableInventario.getValueAt(fila, 1).toString());
            this.jTFNombre.setText(jTableInventario.getValueAt(fila, 3).toString());
            this.jTFCantidad.setText(jTableInventario.getValueAt(fila, 4).toString());
            this.jTFEstado.setText(jTableInventario.getValueAt(fila, 5).toString());
    ...
    private javax.swing.JTextField jTNumHabitacion;
